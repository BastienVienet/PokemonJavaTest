...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        moves.add(new Status("rugissement", 40, 100, -1, "normal"));
        moves.add(new Status("boule'armure", 40, 100, 1, "normal"));
        moves.add(new Damage("lance flamme", 15, 100, 90, "feux"));
        moves.add(new Damage("hydrocanon", 5, 75, 120, "eau"));
        moves.add(new Damage("fatal foudre", 5, 75, 120, "electrique"));
        moves.add(new Damage("psycho", 10, 100, 90, "psy"));
